...
攻击方式：准心瞄准敌方单位，点击鼠标左键，被瞄准的单位受到雷击并麻痹0.2s
...
名字、ID、血量、仇恨值、移动速度、攻击力、攻击速度、掉落金钱

### 设计

| 怪物   | 血量 | 攻击力 | 攻击速度 | 移动速度 | 攻击距离 | 备注                          |
| :----- | ---- | ------ | -------- | -------- | -------- | ----------------------------- |
| 基础怪 | 1    | 1      | 1        | 1        | 5        |                               |
| 弓箭手 | 1    | 1.2    | 0.8      | 1        | 25       |                               |
| 迅猛怪 | 0.6  | 1      | 1.5      | 1.3      | 7        |                               |
| 爆炸怪 | 0.1  | 0      | 0        | 2        | 0        | 只攻击基地、可魅惑、不可嘲讽  |
| 巨怪   | 3    | 2      | 0.5      | 0.5      | 5        |                               |
| 治疗怪 | 1    | 0.3    | 1        | 1        | 10       | aoe恢复血量，攻击力变为回血量 |
| 光环怪 | 1    | 0.8    | 0.5      | 1        | 20       | 提高周围怪物的攻击速度20%     |
| 精英怪 | 10   | 1.5    | 2        | 1        | 10       | 小boss                        |
| 飞行怪 | 0.35 | 1      | 1        | 1        | 30       | 空中单位，路线有所不同        |
| 分裂怪 | 2    | 0.8    | 0.8      | 0.7      | 5        | 打死后分裂为两个怪物          |
| 复仇怪 | 0.2  | 0.3    | 2        | 1        | 5        | 被玩家击杀之后会扣除玩家血量  |
| 坚韧怪 | 1.2  | 0.8    | 0.8      | 1.2      | 5        | 免疫控制                      |
| 瘟疫鸟 | 0.35 | 1      | 1        | 1        | 30       | 被攻击的单位会中毒            |
|        |      |        |          |          |          |                               |
